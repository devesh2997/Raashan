...
import 'package:raashan/widgets/bottom_sheets/alert_sheet.dart';
            ...
            children: <Widget>[
              Expanded(
                child: GestureDetector(
                  ...
                  onTap: () {
                    ...
                    Share.share(
                        'https://play.google.com/store/apps/details?id=in.raashan.raashan_app');
                  },
                ),
              ),
              SizedBox(width: 10,),
              Expanded(
                child: GestureDetector(
                  ...
                  onTap: () {
                    NavigationService.of(context).pop();
                    Share.share(
                        'https://apps.apple.com/us/app/raashan/id1491352619?ls=1');
                  },
                ),
              ),
              SizedBox(width: 10,),
              Expanded(
                child: GestureDetector(
                  ...
                  onTap: () {
                    NavigationService.of(context).pop();
                    Share.share('https://www.raashan.in');
                  },
                ),
              ),
            ],
